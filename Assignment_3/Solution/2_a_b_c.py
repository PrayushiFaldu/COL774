...
# train_data_path = "/home/prayushi/Desktop/IITD/Assignments/ML/Assignment_3/Data/poker-hand-training-true.data"
# test_data_path = "/home/prayushi/Desktop/IITD/Assignments/ML/Assignment_3/Data/poker-hand-testing.data"
...
class MSELoss():
    ...
    def get_derivative_loss(self, actual, predicted):
        return (np.array(predicted) - actual) / len(actual[0])
        ...
        for i in range(epochs):
            ...
            for batch_number in range(total_batches):
                ...
                for layer in reversed(self.layers):
                    batch_wise_error_for_back_prop = layer.backward(batch_wise_error_for_back_prop, learning_rate)
